...
class UserController {
    async createUser(req, res) {
        ...
        [email, nickname, phone, password_, name_, surname])
    ...
    //         const password_ = req.params.password_
    //         const user = await db.query('SELECT * FROM persone where nickname = $1, password_ = $2', [nickname, password_])
    //         res.json(user.rows[0])
    //     }
